...
IDENTICAL: dict[str, list[tuple[str, str]]] = {
    "linux": [
        ...
        ("scripts/tmux-fzf-pane-content.sh", "scripts/tmux-fzf-pane-content.sh"),
        ("scripts/tmux-agents.sh", "scripts/tmux-agents.sh"),
        ...
        (".config/zsh/mux-tmux.zsh", ".config/zsh/mux-tmux.zsh"),
        (".config/zsh/00-history.zsh", ".config/zsh/00-history.zsh"),
        (".config/zsh/30-interactive.zsh", ".config/zsh/30-interactive.zsh"),
        (".config/zsh/90-agent.zsh", ".config/zsh/90-agent.zsh"),
        (".config/zsh/95-session.zsh", ".config/zsh/95-session.zsh"),
