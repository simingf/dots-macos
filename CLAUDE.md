...
| `Library/` (rest), `Brewfile`, `manual/`, `ghostty/`, `kitty/`, `aerospace/`, `karabiner/`, `borders/`, `btop/`, `istherenet/`, `linearmouse/`, `spotify-player/`, `.config/topgrade.toml` | Mac-only | Mac-only | Do NOT mirror. |
